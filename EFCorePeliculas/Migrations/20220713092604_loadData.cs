    ...
    public partial class loadData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 7, 20, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 7, 13, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 7, 18, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 7, 13, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
